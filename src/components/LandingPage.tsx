...
export default function LandingPage({ onNavigate }: LandingPageProps) {
  return (
    <div className="relative h-screen text-[#1a1c1c] font-serif overflow-y-auto overflow-x-hidden selection:bg-black/10">
      ...
      <main className="max-w-4xl mx-auto pt-16 sm:pt-32 pb-24 sm:pb-48 px-4 sm:px-6 text-center relative z-10">
        <motion.header
        ...
        >
          ...
          <h1 className="font-brand text-5xl sm:text-8xl tracking-[-0.05em] mb-8 sm:mb-16 text-black opacity-90 font-semibold select-none">
            RAMBLE.
          </h1>
          
          <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-12">
            <p className="strikethrough text-base sm:text-xl font-sans tracking-widest text-black/40 font-light uppercase select-none">
              not another writing app
            </p>
            <h2 className="text-3xl sm:text-5xl font-light italic text-black/90 tracking-tight select-none">
              it’s a rambling app
            </h2>
          </div>

          <div className="space-y-2 sm:space-y-3 mb-12 sm:mb-20 text-base sm:text-xl font-light tracking-wide text-black/60 max-w-xl mx-auto select-none font-sans px-2">
          ...
          <button
            ...
            className="glass-card rounded-xl py-4 sm:py-6 font-brand text-base sm:text-lg tracking-[0.3em] glow-hover uppercase text-black/90 font-semibold px-12 sm:px-24 opacity-80 hover:opacity-100 transition-opacity duration-300 cursor-pointer"
          >
            Ramble
          </button>
        </motion.header>
        ...
        {/* Feature Grid */}
        <section className="mt-24 sm:mt-48 space-y-24 sm:space-y-48 text-left max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="w-full md:w-1/2 space-y-4 sm:space-y-6">
              <h3 className="text-2xl sm:text-3xl font-light font-sans tracking-tight text-black">a thinking partner.</h3>
              <p className="text-black/55 leading-relaxed font-sans font-light text-base sm:text-lg">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: '-100px' }}
            transition={{ duration: 0.6 }}
            className="flex flex-col md:flex-row-reverse items-center justify-between gap-10 md:gap-20"
          >
            <div className="w-full md:w-1/2 flex justify-center">
            ...
            <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 text-left">
              <h3 className="text-2xl sm:text-3xl font-light font-sans tracking-tight text-black">think out loud.</h3>
              <p className="text-black/55 leading-relaxed font-sans font-light text-base sm:text-lg">
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center">
              <div className="relative scale-100 sm:scale-110 floating" style={{ animationDelay: '-1s' }}>
                ...
                <div className="absolute -top-6 -right-4 sm:-right-12 flex gap-2">
            ...
            <div className="w-full md:w-1/2 space-y-4 sm:space-y-6">
              <h3 className="text-2xl sm:text-3xl font-light font-sans tracking-tight text-black">never lose a thought.</h3>
              <p className="text-black/55 leading-relaxed font-sans font-light text-base sm:text-lg">
          ...
          >
            ...
            <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 text-left">
              <h3 className="text-2xl sm:text-3xl font-light font-sans tracking-tight text-black">companions.</h3>
              <p className="text-black/55 leading-relaxed font-sans font-light text-base sm:text-lg">
        ...
        {/* Philosophy */}
        <section className="mt-32 sm:mt-64 mb-16 sm:mb-32 max-w-2xl mx-auto relative text-center">
          ...
          <h3 className="text-2xl sm:text-4xl font-light font-sans mb-6 sm:mb-12 text-black tracking-tight select-none">our philosophy.</h3>
          <div className="text-black/40 space-y-3 sm:space-y-4 text-base sm:text-xl font-light italic leading-relaxed select-none px-2">
