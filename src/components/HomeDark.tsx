...
import { Search, Sun, Plus, MoreHorizontal, Grid2X2, List, Trash2, ArrowRight, Settings, LogOut } from 'lucide-react';
                    ...
                    >
                      <div className="py-1 select-none">
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-[13px] text-[#a1a1aa] hover:text-white hover:bg-white/5 transition-colors flex items-center gap-2 cursor-pointer font-sans"
                        >
          ...
          <div className="flex items-center gap-6" id="desktop-actions-dark">
            ...
            <div className="relative">
              <button
                ...
                id="desktop-profile-avatar-container-dark"
              >
                <img
                  alt="User Profile"
                  className="w-full h-full object-cover"
        ...
        {isSettingsOpen && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center select-none font-sans text-white">
            ...
            <motion.div
               ...
               exit={{ opacity: 0, scale: 0.95 }}
               className="relative w-full max-w-lg bg-[#131316] border border-white/10 rounded-xl shadow-2xl overflow-hidden flex flex-col h-[350px] p-6 z-10 mx-4"
            >
              ...
              <div className="flex-1 space-y-4 overflow-y-auto pr-1">
                <div>
                  ...
                  <div className="bg-white/5 border border-white/5 p-3 rounded-lg flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm font-semibold text-white">skyash</p>
                      <p className="text-xs text-[#a1a1aa]">yashpc09@gmail.com</p>
                    </div>
                  </div>
                </div>
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-wider text-neutral-500 mb-1">Application Information</h3>
