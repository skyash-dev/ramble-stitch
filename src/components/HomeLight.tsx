...
import { Search, Moon, Plus, MoreHorizontal, Grid2X2, List, Trash2, ArrowRight } from 'lucide-react';
      ...
      <div className="flex md:hidden flex-col h-full bg-[#faf9f7] text-[#1a1c1b] overflow-y-auto no-scrollbar relative" id="mobile-home-light">
        ...
        <header className="fixed top-0 w-full bg-[#faf9f7]/95 backdrop-blur-md flex justify-between items-center h-16 px-6 z-50 border-b border-black/[0.05]" id="mobile-header-light">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#efeeec] border border-black/10 overflow-hidden cursor-pointer" onClick={onProfileClick} id="mobile-profile-avatar-light">
              <img 
                alt="User Profile" 
          ...
          <h1 className="font-sans text-base font-bold tracking-[0.2em] text-black uppercase select-none cursor-pointer" onClick={onLogoClick} id="mobile-brand-title-light text-primary">
            RAMBLE
          </h1>
          <button 
      ...
      <div className="hidden md:flex flex-col h-full w-full overflow-y-auto no-scrollbar" id="desktop-home-light">
        ...
        <header className="h-16 border-b border-[#c4c7c7] flex items-center justify-between px-8 sticky top-0 bg-[#faf9f7]/85 backdrop-blur-md z-50" id="desktop-header-light">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={onLogoClick} id="desktop-logo-container-light">
            <span className="font-brand text-xl tracking-wider text-black uppercase select-none">
              RAMBLE.
            </span>
          </div>
          ...
          <div className="flex items-center gap-6" id="desktop-actions-light">
            ...
            <button 
              ...
              className="h-8 w-8 rounded-full overflow-hidden border border-[#c4c7c7] hover:border-black/30 transition-colors focus:outline-none"
